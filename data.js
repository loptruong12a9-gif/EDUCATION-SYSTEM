...
const SHOP_ITEMS = [
    ...
    { id: '2026_magic_mushroom', name: 'Nấm Thần Kỳ', emoji: '🍄', price: 10, desc: 'Vẻ đẹp của thiên nhiên huyền bí.' },
    { id: '2026_sunflower_vibes', name: 'Hướng Dương Rực Rỡ', emoji: '🌻', price: 10, desc: 'Luôn hướng về phía mặt trời.' },
    { id: 'item_hat', name: 'Mũ Phù Thủy', emoji: '🧙', price: 12, desc: 'Biến hình trong nháy mắt.' },
    { id: '2026_frog_crown', name: 'Hoàng tử Ếch', emoji: '🐸', price: 12, desc: 'Chú ếch Cottagecore đáng yêu.' },
    { id: '2026_glitch_heart', name: 'Trái tim Glitch', emoji: '💖', price: 12, desc: 'Hiệu ứng nhiễu điện tử siêu độc.' },
    ...
    { id: '2026_neon_butterfly', name: 'Bướm Neon Y2K', emoji: '🦋', price: 15, desc: 'Phong cách Neon cực cháy năm 2026!' },
    { id: '2026_cyber_cat', name: 'Mèo Cyberpunk', emoji: '🐱‍💻', price: 18, desc: 'Mèo máy đến từ tương lai.' },
    { id: 'pet_cat', name: 'Mèo máy Luna', emoji: '🐱‍🚀', price: 20, desc: 'Người bạn đồng hành thông thái.' },
    { id: '2026_alien_peace', name: 'Người ngoài hành tinh', emoji: '👽', price: 20, desc: 'Đến hòa bình cùng nhân loại.' },
    { id: '2026_retro_gameboy', name: 'Máy game Retro', emoji: '🎮', price: 25, desc: 'Sành điệu và hoài niệm.' },
    { id: '2026_astronaut_chill', name: 'Phi hành gia Chill', emoji: '👨‍🚀', price: 30, desc: 'Dạo chơi giữa các vì sao.' },
    ...
    { id: '2026_galactic_whale', name: 'Cá voi Thiên hà', emoji: '🐋', price: 45, desc: 'Sinh vật huyền thoại của vũ trụ.' },
